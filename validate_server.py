...
def check_key_features():
    ...
    features = {
        ...
        "Progress tracking": "get_job_progress" in open("server/routers/jobs.py").read(),
        "Error detection": "detect_errors" in open("server/services/sfe_service.py").read(),
        ...
        "OmniCore routing": "route_job" in open("server/services/omnicore_service.py").read(),
