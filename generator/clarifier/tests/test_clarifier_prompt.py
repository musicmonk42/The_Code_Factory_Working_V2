...
patcher_get_config = patch('generator.clarifier.clarifier_prompt.get_config', return_value=mock_config_instance)
patcher_get_fernet = patch('generator.clarifier.clarifier_prompt.get_fernet', return_value=mock_fernet_instance)
patcher_get_logger = patch('generator.clarifier.clarifier_prompt.get_logger', return_value=mock_logger)
patcher_get_tracer = patch('generator.clarifier.clarifier_prompt.get_tracer', return_value=(mock_tracer, MockStatus, MockStatusCode))
patcher_get_circuit_breaker = patch('generator.clarifier.clarifier_prompt.get_circuit_breaker', return_value=mock_circuit_breaker)
patcher_log_action = patch('generator.clarifier.clarifier_prompt.log_action', return_value=None)
patcher_send_alert = patch('generator.clarifier.clarifier_prompt.send_alert', new_callable=AsyncMock)
...
mock_core_clarifier.get_clarifications = AsyncMock(return_value={"features": ["updated"], "clarifications": {}})
...
class TestPromptClarifier(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_compliance_query_failure(self):
        ...
        mock_channel.ask_compliance_questions = AsyncMock(side_effect=Exception("Compliance failed"))
    ...
    async def test_core_clarifier_failure(self):
        ...
        mock_core_clarifier.get_clarifications = AsyncMock(side_effect=Exception("Core clarifier failed"))
