...
class ScoreCalculator:
    ...
    def calculate(self, ambiguity: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _score_context_relevance(
        self, word_set: frozenset, context: Dict[str, Any]
    ) -> float:
...
class QuestionGenerator:
    ...
    LLM_PROMPT_TEMPLATE: Final[
        str
    ] = """You are a senior software requirements analyst helping to clarify ambiguous requirements. Generate a clear, actionable clarifying question.
...
Your question:"""
    ...
    def __init__(
        self, llm: Optional[Any] = None, config: Optional[PrioritizationConfig] = None
    ):
        """
    ...
    async def generate(
        self, ambiguity: str, context: Dict[str, Any], target_language: str = "en"
    ) -> Dict[str, Any]:
        """
    ...
    async def _generate_with_llm(
        self, ambiguity: str, context: Dict[str, Any], target_language: str
    ) -> Dict[str, Any]:
        ...
        prompt = self.LLM_PROMPT_TEMPLATE.format(
            ...
            or "No prior clarification history available.",
        )
    ...
    def _generate_rule_based(
        self, ambiguity: str, target_language: str
    ) -> Dict[str, Any]:
...
class DefaultPrioritizer(Prioritizer):
    ...
    def _validate_ambiguities(self, ambiguities: List[str]) -> List[Tuple[int, str]]:
        """
        Validate and filter ambiguities.
