...
def mock_settings(monkeypatch):
    ...
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops.settings", mock_settings_obj)
...
def mock_crypto_provider_factory(monkeypatch, mock_crypto_provider):
    ...
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops.crypto_provider_factory", mock_factory)
    return mock_factory
...
def mock_metrics(monkeypatch):
    ...
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops.CRYPTO_ERRORS", mock_counter)
    return mock_counter
...
def mock_fallback_secret(monkeypatch):
    ...
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops._FALLBACK_HMAC_SECRET", secret)
    return secret
...
def reset_ops_global_state(monkeypatch):
    ...
    """
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops._FALLBACK_ATTEMPT_COUNT", {})
    monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops._LAST_FALLBACK_ALERT_TIME", 0.0)
...
@pytest.mark.usefixtures("mock_settings", "mock_crypto_provider_factory", "mock_log_action", "mock_send_alert", "mock_metrics", "mock_fallback_secret")
...
class TestSigning:
    ...
    @pytest.mark.asyncio
    async def test_sign_entry_success(self, mock_crypto_provider, mock_log_action, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import sign_entry, compute_hash
        ...
        # Check log_action
        mock_log_action.assert_called_once_with('crypto_key_operation', {
            'operation': 'sign', 
            'key_id': key_id, 
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("invalid_entry, key, p_hash, expected_error", [
    ...
    @pytest.mark.asyncio
    async def test_sign_entry_provider_failure(self, mock_crypto_provider, mock_metrics, mock_log_action, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import sign_entry
        ...
        # Check error metric
        mock_metrics.labels.assert_called_once_with(type="KeyNotFoundError", provider_type="mock_provider", operation="sign_entry")
    ...
    @pytest.mark.asyncio
    async def test_sign_entry_unexpected_failure(self, mock_crypto_provider, mock_metrics, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import sign_entry
        ...
        # Check error metric
        mock_metrics.labels.assert_called_once_with(type="UnexpectedError", provider_type="mock_provider", operation="sign_entry")

    @pytest.mark.asyncio
    async def test_stream_sign_entry_success(self, mock_crypto_provider, mock_log_action, sample_stream_metadata):
    ...
    async def test_stream_sign_entry_hash_failure(self, mock_metrics, sample_stream_metadata):
        ...
        mock_metrics.labels.assert_called_once_with(type="StreamingHashFail", provider_type="utility", operation="stream_sign")
...
class TestVerification:
    ...
    @pytest.mark.asyncio
    async def test_verify_entry_success(self, mock_crypto_provider, mock_log_action, sample_entry_data):
        ...
        mock_crypto_provider.verify.assert_called_once_with(b"mock-signature-bytes", expected_verified_data, key_id)
    ...
    @pytest.mark.asyncio
    async def test_verify_entry_invalid_signature(self, mock_crypto_provider, mock_metrics, mock_log_action, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_entry
        ...
        # Check metric
        mock_metrics.labels.assert_called_once_with(type="InvalidSignature", provider_type="mock_provider", operation="verify_entry")
    ...
    @pytest.mark.asyncio
    async def test_verify_entry_invalid_base64(self, mock_crypto_provider, mock_metrics, mock_log_action, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_entry
        ...
        # Check metric
        mock_metrics.labels.assert_called_once_with(type="Base64DecodeError", provider_type="unknown", operation="verify_entry")
    ...
    @pytest.mark.asyncio
    async def test_verify_entry_provider_error(self, mock_crypto_provider, mock_metrics, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_entry
        ...
        mock_metrics.labels.assert_called_once_with(type="HSMError", provider_type="mock_provider", operation="verify_entry")

    @pytest.mark.asyncio
    async def test_stream_verify_entry_success(self, mock_crypto_provider, mock_log_action, sample_stream_metadata):
    ...
    @pytest.mark.asyncio
    async def test_stream_verify_entry_hash_fail(self, mock_metrics, mock_crypto_provider, sample_stream_metadata):
        from generator.audit_log.audit_crypto.audit_crypto_ops import stream_verify_entry
        
        stream_data = [b"chunk1", RuntimeError("stream read error")]
        
        result = await stream_verify_entry(async_gen(stream_data), sample_stream_metadata, "c2ln=", "key-1")
        
        assert result is False
        mock_metrics.labels.assert_called_once_with(type="StreamingHashFail", provider_type="utility", operation="stream_verify")
        mock_crypto_provider.verify.assert_not_called()
        
    @pytest.mark.asyncio
    async def test_stream_verify_entry_invalid_signature(self, mock_crypto_provider, mock_metrics, sample_stream_metadata):
        from generator.audit_log.audit_crypto.audit_crypto_ops import stream_verify_entry
        
        mock_crypto_provider.verify.side_effect = InvalidSignature("sig mismatch")
        
        result = await stream_verify_entry(async_gen([b"data"]), sample_stream_metadata, "c2ln=", "key-1")
        
        assert result is False
        mock_metrics.labels.assert_called_once_with(type="InvalidSignature", provider_type="mock_provider", operation="stream_verify")


@patch("generator.audit_log.audit_crypto.audit_crypto_ops.verify_entry", new_callable=AsyncMock)
...
class TestChainVerification:
    ...
    @pytest.mark.asyncio
    async def test_verify_chain_success(self, mock_compute_hash, mock_verify_entry, mock_log_action):
    ...
    @pytest.mark.asyncio
    async def test_verify_chain_hash_mismatch(self, mock_compute_hash, mock_verify_entry, mock_metrics, mock_log_action):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_chain
        ...
        mock_metrics.labels.assert_called_once_with(type="ChainIntegrityFail", provider_type="unknown", operation="verify_chain")
        mock_log_action.assert_called_with("verify_chain", status="fail", reason="hash_mismatch", entry_index=2, entry_id="id-2")

    @pytest.mark.asyncio
    async def test_verify_chain_signature_fail(self, mock_compute_hash, mock_verify_entry, mock_log_action):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_chain
        ...
        mock_log_action.assert_called_with("verify_chain", status="fail", reason="cryptographic_mismatch")

    @pytest.mark.asyncio
    async def test_verify_chain_missing_signature(self, mock_compute_hash, mock_verify_entry, mock_metrics, mock_log_action):
        from generator.audit_log.audit_crypto.audit_crypto_ops import verify_chain
        ...
        mock_metrics.labels.assert_called_once_with(type="MissingSigOrKey", provider_type="unknown", operation="verify_chain")
        mock_log_action.assert_called_with("verify_chain", status="fail", reason="missing_sig_or_key", entry_index=1, entry_id="id-1")
...
class TestRotation:
    ...
    @pytest.mark.asyncio
    async def test_rotate_key_provider_fail(self, mock_crypto_provider, mock_metrics, mock_log_action):
        from generator.audit_log.audit_crypto.audit_crypto_ops import rotate_key
        ...
        mock_metrics.labels.assert_called_once_with(type="HSMError", provider_type="mock_provider", operation="rotate_key")
...
@pytest.mark.usefixtures("mock_settings", "mock_crypto_provider_factory", "mock_log_action", "mock_send_alert", "mock_metrics", "mock_fallback_secret", "mock_time", "mock_asyncio_sleep")
class TestFallbackLogic:
    ...
    @pytest.mark.asyncio
    async def test_safe_sign_primary_success(self, mock_crypto_provider, mock_log_action, sample_entry_data):
    ...
    @pytest.mark.asyncio
    async def test_safe_sign_primary_fail_fallback_success(self, mock_crypto_provider, mock_log_action, mock_metrics, mock_fallback_secret, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import safe_sign
        ...
        mock_metrics.labels.assert_called_once_with(type="PrimarySignFail", provider_type="mock_provider", operation="safe_sign")
        
        mock_log_action.assert_has_calls([
            call('crypto_primary_sign_fail', {'operation': 'sign', 'key_id': 'key-1', 'entry_id': sample_entry_data['entry_id'], 'reason': 'HSM is offline'}),
            call('crypto_fallback_sign', {'operation': 'sign', 'key_id': 'HMAC_FALLBACK', 'entry_id': sample_entry_data['entry_id'], 'reason': 'HSM is offline', 'success': True})
        ])

    @pytest.mark.asyncio
    async def test_safe_sign_primary_and_fallback_fail(self, mock_crypto_provider, mock_log_action, mock_metrics, mock_send_alert, sample_entry_data, monkeypatch):
        from generator.audit_log.audit_crypto.audit_crypto_ops import safe_sign
        ...
        monkeypatch.setattr("generator.audit_log.audit_crypto.audit_crypto_ops._FALLBACK_HMAC_SECRET", None)
        ...
        mock_metrics.labels.assert_any_call(type="PrimarySignFail", provider_type="mock_provider", operation="safe_sign")
        mock_metrics.labels.assert_any_call(type="FallbackSecretMissing", provider_type="fallback", operation="hmac_sign")
        mock_metrics.labels.assert_any_call(type="FallbackSignFail", provider_type="fallback", operation="safe_sign")
    ...
    @pytest.mark.asyncio
    async def test_safe_sign_fallback_alerting_logic(self, mock_crypto_provider, mock_settings, mock_log_action, mock_send_alert, mock_time, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import safe_sign, _FALLBACK_ATTEMPT_COUNT
    ...
    @pytest.mark.asyncio
    async def test_safe_sign_fallback_auto_disable(self, mock_crypto_provider, mock_settings, mock_send_alert, sample_entry_data):
        from generator.audit_log.audit_crypto.audit_crypto_ops import safe_sign, _FALLBACK_ATTEMPT_COUNT
