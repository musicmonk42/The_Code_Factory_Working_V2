...
def mock_dependencies():
    ...
    with patch('generator.main.main.Runner') as mock_runner, \
...
class TestInterfaceLaunching:
    ...
    async def test_gui_interface_launch(self, mock_dependencies):
        ...
        with patch('generator.main.main.main_cli') as mock_cli, \
    ...
    async def test_api_interface_launch(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.uvicorn') as mock_uvicorn, \
...
class TestAllInterfaceMode:
    ...
    async def test_all_mode_api_readiness_check(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.aiohttp.ClientSession') as MockSession, \
...
class TestErrorHandling:
    ...
    async def test_import_error_handling(self):
        ...
        with patch('generator.main.main.IMPORT_ERROR', Exception("Import failed")), \
             patch('generator.main.main.logger') as mock_logger:
    ...
    def test_critical_error_alert(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.send_alert') as mock_alert, \
             patch('generator.main.main.asyncio.run') as mock_run:
    ...
    def test_gui_crash_handling(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.MainApp') as MockApp, \
             patch('generator.main.main.send_alert') as mock_alert, \
             patch('generator.main.main.asyncio.run') as mock_run, \
             patch('generator.main.main.logger') as mock_logger:
...
class TestOpenTelemetry:
    ...
    def test_tracer_initialization(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.trace') as mock_trace, \
...
class TestMainEntryPoint:
    ...
    def test_main_entry_point_successful(self):
        ...
        # FIX: Patch 'generator.main.main.X'
        with patch('generator.main.main.main') as mock_main, \
