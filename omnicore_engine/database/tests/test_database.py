...
from models import AgentState, ExplainAuditRecord, Base
...
class TestAgentStateOperations:
    ...
    async def test_save_agent_state(self, database):
        ...
        with patch.object(database.policy_engine, 'should_auto_learn', return_value=(True, "Allowed")):
...
class TestSnapshotOperations:
    ...
    async def test_snapshot_and_get_audit_state(self, database):
        ...
        state = {"agents": ["agent1", "agent2"], "timestamp": datetime.utcnow().isoformat()}
