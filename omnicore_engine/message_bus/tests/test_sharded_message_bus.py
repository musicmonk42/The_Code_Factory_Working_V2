...
from message_bus.sharded_message_bus import (
    ShardedMessageBus, RateLimiter, RateLimitError,
    validate_message_size, sign_message, verify_message,
    MAX_MESSAGE_SIZE
)
from message_bus.message_types import Message
from message_bus.resilience import RetryPolicy
...
class TestShardedMessageBus(unittest.TestCase):
    ...
    async def test_publish_basic(self):
        ...
        with patch('message_bus.sharded_message_bus.KafkaBridge'), \
             patch('message_bus.sharded_message_bus.RedisBridge'), \
             patch('message_bus.sharded_message_bus.DeadLetterQueue'):
    ...
    async def test_shutdown(self):
        ...
        with patch('message_bus.sharded_message_bus.KafkaBridge') as mock_kafka, \
