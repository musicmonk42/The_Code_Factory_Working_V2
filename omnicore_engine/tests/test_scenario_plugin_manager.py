...
class TestExplainableAI:
    ...
    def test_initialization_with_reasoner(self):
        ...
        with patch('omnicore_engine.scenario_plugin_manager.ExplainableReasoner', return_value=mock_reasoner):
            ai = ExplainableAI()
...
class TestOmniCoreEngine:
    ...
    async def test_initialize_components(self, mock_feedback, mock_observer, mock_registry, 
                                        mock_audit, mock_db, engine):
