...
def aws_secrets_manager(monkeypatch):
   ...
   monkeypatch.setattr('self_healing_import_fixer.analyzer.core_secrets.ClientError', MockClientError)
   ...
   with patch("self_healing_import_fixer.analyzer.core_secrets.boto3.client", return_value=mock_client):
