...
class TestAlertSystem:
    ...
    def test_alert_operator_basic(self, caplog):
        ...
        with caplog.at_level('ERROR'):
            ...
            assert any("Test alert" in record.message or "Failed to send alert" in record.message 
    ...
    def test_alert_operator_with_details(self, caplog):
        ...
        with caplog.at_level('WARNING'):
            ...
            assert any("Login failure" in record.message or "Failed to send alert" in record.message 
                      for record in caplog.records)
    ...
    def test_multiple_channels(self, caplog):
        ...
        with patch('urllib.request.urlopen') as mock_urlopen:
            _alert_config.slack_webhook_url = "https://hooks.slack.com/test"
            _alert_config.webhook_urls = ["https://webhook1.com", "https://webhook2.com"]
