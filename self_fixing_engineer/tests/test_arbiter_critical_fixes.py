...
class TestExplainableReasonerExport:
    ...
    def test_explainable_reasoner_import(self):
        ...
        assert (
            "config" in params
        ), "Real ExplainableReasoner should have config parameter"
...
class TestVaultSecretManager:
    ...
    async def test_vault_fallback_mode(self):
        ...
        with patch.dict(
            os.environ, {"VAULT_FALLBACK_MODE": "true", "PRODUCTION_MODE": "false"}
        ):
            from self_fixing_engineer.intent_capture.agent_core import (
                VaultSecretManager,
            )
    ...
    async def test_vault_production_mode_enforcement(self):
        ...
        with patch.dict(
            os.environ, {"PRODUCTION_MODE": "true", "VAULT_FALLBACK_MODE": "false"}
        ):
            from self_fixing_engineer.intent_capture.agent_core import (
                VaultSecretManager,
            )
...
class TestSecretScrubbing:
    ...
    def test_secret_scrubbing_basic(self):
        ...
        data = {"username": "alice", "password": "secret123", "api_secret": "key456"}
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.dict(os.environ, {"METRICS_LOG_FILE": metrics_file}):
                ...
                with open(metrics_file, "a") as f:
                    metric_data = {"type": "counter", "name": "test_metric", "value": 1}
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch.dict(os.environ, {"TRACE_LOG_FILE": trace_file}):
                ...
                with open(trace_file, "a") as f:
                    trace_data = {"span_name": "test_span", "event_type": "span_start"}
