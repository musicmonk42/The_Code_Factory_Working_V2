...
def ensure_real_aiofiles():
    ...
    # Check if aiofiles is mocked
    is_mocked = "aiofiles" in sys.modules and (
        isinstance(sys.modules["aiofiles"], MagicMock) 
        or getattr(sys.modules["aiofiles"], "__name__", "") == "MagicMock"
        or hasattr(sys.modules["aiofiles"], "mock_calls")
    )
