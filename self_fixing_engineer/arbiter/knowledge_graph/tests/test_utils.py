...
class TestPIIRedaction:
    ...
    def test_redact_sensitive_pii_key_match(self):
        ...
        # Fix: Use correct module path
        with patch('arbiter.knowledge_graph.utils.Config.PII_SENSITIVE_KEYS', ['password', 'ssn', 'email']):
            with patch('arbiter.knowledge_graph.utils.Config.GDPR_MODE', True):
                with patch('arbiter.knowledge_graph.utils.AGENT_METRICS') as mock_metrics:
                    ...
                    mock_metrics["sensitive_data_redaction_total"].labels.assert_called_with(redaction_type="key")
    ...
    def test_redact_sensitive_pii_pattern_email(self):
        ...
        with patch('arbiter.knowledge_graph.utils.AGENT_METRICS') as mock_metrics:
            ...
            mock_metrics["sensitive_data_redaction_total"].labels.assert_called_with(redaction_type="pattern")
...
class TestSanitizeContext:
    ...
    async def test_sanitize_with_sensitive_keys(self):
        ...
        with patch('arbiter.knowledge_graph.utils.Config.PII_SENSITIVE_KEYS', ['password', 'email']):
            result = await _sanitize_context(context)
    ...
    async def test_sanitize_nested_context(self):
        ...
        with patch('arbiter.knowledge_graph.utils.Config.PII_SENSITIVE_KEYS', ['password', 'name']):
            result = await _sanitize_context(context)
...
class TestSanitizeUserInput:
    ...
    def test_sanitize_prompt_injection(self):
        ...
        with patch('arbiter.knowledge_graph.utils.AGENT_METRICS') as mock_metrics:
            ...
            mock_metrics["sensitive_data_redaction_total"].labels.assert_called_with(redaction_type="prompt_injection")
...
class TestAuditLedgerClient:
    ...
    def test_client_initialization(self):
        ...
        with patch('arbiter.knowledge_graph.utils.Config.AUDIT_LEDGER_URL', "http://localhost:8000/audit_ledger"):
...
class TestIntegration:
    ...
    async def test_full_context_sanitization_flow(self):
        ...
        with patch('arbiter.knowledge_graph.utils.Config.PII_SENSITIVE_KEYS', ['password', 'name', 'email']):
