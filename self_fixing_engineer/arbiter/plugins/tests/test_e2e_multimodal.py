...
class TestE2EMultiModalSystem:
    ...
    async def test_circuit_breaker_e2e(self, plugin_with_config):
        ...
        with patch.object(plugin_with_config.text_processor, 'process', 
    ...
    async def test_context_manager_e2e(self):
        ...
        config = {
            ...
            "audit_log_config": {"enabled": False, "log_level": "INFO", "destination": "console"}
        }
...
def mock_metrics():
    ...
    with patch('arbiter.plugins.multi_modal_plugin.get_or_create_counter', get_or_create), \
         patch('arbiter.plugins.multi_modal_plugin.get_or_create_histogram', get_or_create), \
         patch('arbiter.plugins.multimodal.providers.default_multimodal_providers.get_or_create', get_or_create), \
