...
class TestConfigSchemas:
    ...
    def test_default_image_processor_config_valid(self):
        ...
        config = DefaultImageProcessorConfig(
            mock_min_latency_ms=20,
            mock_max_latency_ms=200,
            max_size_mb=15
        )
...
class TestDefaultImageProcessor:
    ...
    def processor(self):
        ...
        with patch('arbiter.plugins.multimodal.providers.default_multimodal_providers.get_or_create', get_or_create):
...
class TestDefaultVideoProcessor:
    ...
    def processor(self):
        ...
        config = {"mock_min_latency_ms": 1, "mock_max_latency_ms": 2, "max_size_mb": 100}
        with patch('arbiter.plugins.multimodal.providers.default_multimodal_providers.get_or_create', get_or_create):
...
class TestDefaultTextProcessor:
    ...
    def processor(self):
        ...
        config = {"mock_min_latency_ms": 1, "mock_max_latency_ms": 2, "max_length": 1000}
        with patch('arbiter.plugins.multimodal.providers.default_multimodal_providers.get_or_create', get_or_create):
