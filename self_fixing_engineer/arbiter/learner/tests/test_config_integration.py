...
class TestConfigIntegration:
    ...
    async def test_all_parsers_loadable(self):
        ...
        with patch('arbiter.learner.fuzzy.load_parser_priorities') as mock_load:
            ...
            with patch.dict('sys.modules', {'arbiter.learner.fuzzy': MagicMock(PARSER_PRIORITIES=mock_priorities)}):
    ...
    async def test_all_templates_usable(self, mock_learner):
        ...
        with patch('arbiter.learner.explanations._load_prompt_templates'):
            with patch.dict('sys.modules', {
                ...
                from arbiter.learner.explanations import _load_prompt_templates, EXPLANATION_PROMPT_TEMPLATES, generate_explanation
    ...
    async def test_parser_config_integration(self):
        ...
        if config_path.exists():
            ...
            with patch('arbiter.learner.fuzzy.PARSER_PRIORITIES', config_data["parser_priorities"]):
    ...
    async def test_template_config_integration(self):
        ...
        if config_path.exists():
            ...
            with patch('arbiter.learner.explanations.EXPLANATION_PROMPT_TEMPLATES', config_data["templates"]):
