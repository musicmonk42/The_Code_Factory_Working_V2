...
class TestExplanationPromptConfig:
    ...
    def test_all_templates_present(self, template_data):
        ...
        expected_templates = [
            "new_fact", "updated_fact", "unchanged_fact",
            "conflict_resolution", "batch_summary", "security_alert",
            "data_quality_assessment", "compliance_check",
            "performance_analysis", "audit_trail"
        ]
    ...
    def test_template_variables_in_text(self, template_data):
        ...
        for template_name, config in template_data.items():
            ...
            for variable in config["variables"]:
                assert f"{{{variable}}}" in template_text, \
