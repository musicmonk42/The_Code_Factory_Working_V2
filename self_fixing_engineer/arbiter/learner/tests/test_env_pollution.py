...
def test_decision_optimizer_settings_env_pollution(monkeypatch):
    ...
    print("DECISION_OPTIMIZER_SETTINGS in env at test start:", "DECISION_OPTIMIZER_SETTINGS" in os.environ)
    print("DECISION_OPTIMIZER_SETTINGS value:", os.environ.get("DECISION_OPTIMIZER_SETTINGS"))

    # Remove it for this test and print again
    os.environ.pop("DECISION_OPTIMIZER_SETTINGS", None)
    print("After pop, DECISION_OPTIMIZER_SETTINGS in env:", "DECISION_OPTIMIZER_SETTINGS" in os.environ)
    ...
    try:
        ...
        print("ArbiterConfig.DECISION_OPTIMIZER_SETTINGS keys:", list(config.DECISION_OPTIMIZER_SETTINGS.keys()))
    ...
    # Check for pollution
    pollution_keys = [
        "REDIS_URL", "NEO4J_URL", "APP_ENV", "OPENAI_API_KEY",
        "ANTHROPIC_API_KEY", "GEMINI_API_KEY", "LLM_API_KEY"
    ]
