...
class TestSamplingStrategy:
    ...
    def test_should_sample_operation_override(self):
        ...
        strategy = SamplingStrategy(
            base_rate=0.0,
            operation_rates={"critical_operation": 1.0}
        )
    ...
    def test_should_sample_service_override(self):
        ...
        strategy = SamplingStrategy(
            base_rate=0.0,
            service_rates={"important_service": 1.0}
        )
...
class TestOpenTelemetryConfig:
    ...
    @patch.dict(os.environ, {"OTEL_SERVICE_NAME": "test_service", "OTEL_SERVICE_VERSION": "2.0.0"})
