...
def setup_test_environment():
    ...
    opentelemetry.exporter.otlp.proto.grpc = create_mock_module('opentelemetry.exporter.otlp.proto.grpc')
    opentelemetry.exporter.otlp.proto.grpc.trace_exporter = create_mock_module('opentelemetry.exporter.otlp.proto.grpc.trace_exporter')
    ...
    sys.modules['opentelemetry.exporter.otlp.proto.grpc.trace_exporter'] = opentelemetry.exporter.otlp.proto.grpc.trace_exporter
...
class TestProcessEvent:
    ...
    async def test_successful_delivery(self, mock_mq_service, mock_audit_logger):
        ...
        with patch.object(queue_consumer_worker, 'send_to_external_notifier', 
...
class TestHandleMessage:
    ...
    async def test_handle_message_calls_process(self, mock_mq_service, mock_audit_logger):
        ...
        with patch.object(queue_consumer_worker, 'process_event', 
