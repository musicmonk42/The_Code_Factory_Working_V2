...
async def test_rate_limited_with_redis(mock_redis):
    ...
    class MyClass:
        ...
        @rate_limited(calls_per_second=10.0, key_extractor=lambda self, kwargs: kwargs.get("user_id", "global"))
