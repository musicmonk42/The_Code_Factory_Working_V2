...
_OFFLINE_MODE = os.environ.get("TEST_GENERATION_OFFLINE_MODE", "false").lower() == "true"
...
class DummyEventBus:
    ...
    async def publish(self, *args, **kwargs):
        ...
        if _ENVIRONMENT == "production":
            log(
                "CRITICAL: DummyEventBus.publish called in PRODUCTION!",
                level="ERROR"
            )
...
class DummyKnowledgeGraphClient:
    ...
    async def update_module_metrics(self, *args, **kwargs):
        ...
        if _ENVIRONMENT == "production":
            log(
                "CRITICAL: DummyKnowledgeGraphClient used in PRODUCTION!",
                level="ERROR"
            )
...
class DummyPRCreator:
    ...
    async def create_pr(self, *args, **kwargs):
        ...
        """
        pr_info = {"args": args, "kwargs": kwargs, "url": "https://github.com/stub-pr-url"}
    ...
    async def create_jira_ticket(self, *args, **kwargs):
        ...
        """
        ticket_info = {"args": args, "kwargs": kwargs, "url": "https://jira.com/stub-ticket"}
