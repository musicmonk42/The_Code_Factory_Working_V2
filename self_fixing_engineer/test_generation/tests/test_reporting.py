...
from test_generation.orchestrator.config import HTML_REPORTS_DIR, SARIF_EXPORT_DIR

# Fix: The test needs to import the HTMLReporter and its config path
from test_generation.orchestrator.reporting import (
    DummyMetric,
    HTMLReporter,
    _write_sarif_atomically,
)
...
async def test_generate_html_report_success(project: Path, monkeypatch):
    ...
    overall_results = {
        "summary": {
            ...
            "total_targets_considered": 1,
        },
        "details": {
            "test_module": {
                "integration_status": "INTEGRATED",
                "test_passed": True,
                "coverage_increase_percent": 10.0,
        ...
        "ai_metrics": {
            "refinement_success_rate_percent": 100.0,
