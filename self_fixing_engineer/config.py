...
class ConfigWrapper:
    ...
    def __repr__(self) -> str:
        ...
        config_type = type(self._arbiter_config).__name__ if self._arbiter_config else "None"
    ...
    def _load_config(cls) -> ConfigWrapper:
        ...
        if _has_arbiter_config:
            try:
                ...
                try:
                    ...
                    logger.info("Successfully initialized ArbiterConfig via initialize()")
        ...
        class MinimalConfig:
            ...
            def __repr__(self) -> str:
                ...
                return f"MinimalConfig(env={self.APP_ENV}, database={self.DATABASE_URL})"
