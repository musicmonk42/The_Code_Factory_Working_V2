...
warnings.filterwarnings(
    ...
    message="coroutine '_monitor_config_changes' was never awaited",
)
...
class TestPluginDiscovery:
    ...
    @pytest.mark.skipif(
        not callable(discover_and_register_plugin_entrypoints),
...
class TestValidation:
    ...
    @pytest.mark.skipif(
        not callable(validate_deployment_or_exit),
        reason="Function not properly imported",
    )
...
class TestUtilityFunctions:
    ...
    def test_parse_plugin_args_valid(self):
        ...
        assert result == {"key1": "value1", "key2": "value with spaces", "key3": "123"}
...
class TestResultAggregation:
    ...
    def test_aggregate_simple(self):
        ...
        plugin_results = [{"plugin_name": "test_plugin", "result": {"status": "OK"}}]
