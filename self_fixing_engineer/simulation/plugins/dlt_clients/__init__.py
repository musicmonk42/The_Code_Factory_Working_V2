...
try:
    ...
    _base_logger.warning("python-json-logger not found. JSON logging will be disabled. Install with `pip install python-json-logger`.")
    jsonlogger = None
...
if not _base_logger.handlers:
    ...
    ) if jsonlogger else logging.Formatter(
