...
class TestExceptionSubclasses:
    ...
    def test_backend_error(self):
        ...
        from mesh.checkpoint.checkpoint_exceptions import CheckpointBackendError, CheckpointErrorCode
    ...
    def test_retryable_error(self):
        ...
        error = CheckpointRetryableError(
    ...
    def test_validation_error(self):
        ...
        from mesh.checkpoint.checkpoint_exceptions import CheckpointValidationError, CheckpointErrorCode
...
class TestRetryDecorator:
    ...
    async def test_successful_retry(self):
        ...
        from mesh.checkpoint.checkpoint_exceptions import retry_on_exception, CheckpointRetryableError
...
class TestEdgeCases:
    ...
    def test_custom_error_code(self):
        ...
        # Test with enum
        error1 = CheckpointError(TestConstants.MESSAGE, error_code=CheckpointErrorCode.HASH_MISMATCH)
    ...
    def test_missing_dependencies(self):
        ...
        with patch("mesh.checkpoint.checkpoint_exceptions.PROMETHEUS_AVAILABLE", False), \
             patch("mesh.checkpoint.checkpoint_exceptions.OPENTELEMETRY_AVAILABLE", False), \
