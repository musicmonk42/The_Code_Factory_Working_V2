...
class TestData:
    ...
    NESTED_DICT = {"level1": {"level2": {"level3": "deep_value"}, "array": [1, 2, 3]}}
...
class TestValidation:
    ...
    def test_validate_checkpoint_data(self):
        ...
        valid_data = {
            "state": {"key": "value"},
            "metadata": {"timestamp": datetime.now().isoformat(), "hash": "test_hash"},
        }
...
class TestSecurityCompliance:
    ...
    def test_fips_mode(self):
        ...
        assert SecurityConfig.HASH_ALGORITHM in [
            "SHA256",
            "SHA384",
            "SHA512",
            "SHA3-256",
