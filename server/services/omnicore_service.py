...
# Phase 2 decomposition: import helpers extracted in Phase 1
from server.services.helpers import (
    _build_delta_prompt,
...
DEFAULT_SFE_ANALYSIS_TIMEOUT = int(os.getenv("SFE_ANALYSIS_TIMEOUT_SECONDS", "300"))
...
# File Size Limits, Helm constants, and README constants are now imported
# from server.services.helpers (Phase 1 decomposition).
# MAX_REPORT_FILE_SIZE_BYTES -> helpers.sfe_cache
# HELM_REQUIRED_FIELDS       -> helpers.validation
# MAX_FILES_IN_README, MAX_DEPENDENCIES_IN_README -> helpers.fallback_generators
# TEST_FILE_PATTERNS          -> helpers.project_detection
...
# Constants for README generation (MAX_FILES_IN_README, MAX_DEPENDENCIES_IN_README
# are now imported from server.services.helpers.fallback_generators)
...
# TEST_FILE_PATTERNS is now imported from server.services.helpers.project_detection


# Helper functions extracted to server.services.helpers (Phase 1 decomposition)
# See: helpers/validation.py, helpers/project_detection.py, helpers/fallback_generators.py,
#      helpers/file_utils.py, helpers/sfe_cache.py


# [Phase 2] The remaining original helper function definitions have been removed.
# All 16 helper functions are now imported from server.services.helpers above.
...
# Compatibility re-exports -- external code may import these from here
# Remove these once all consumers are updated to import from server.services.helpers
__all__ = [
    "_build_delta_prompt",
    "_create_placeholder_critique_report",
    "_detect_project_language",
